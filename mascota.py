...
"""Command-line entry point for Project Mascota (T9)."""
...
from library.mascota.app import MascotaApp, SingleInstanceError


def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    """Parse command line arguments for Mascota."""
    parser = argparse.ArgumentParser(
        description="Mascota: dashboard reactivo para Turing Smart Screen 3.5\""
    )
    parser.add_argument(
        "--tick",
        type=float,
